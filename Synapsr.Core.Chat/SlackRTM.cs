namespace Synapsr.Core.Chat
{
	...
	public class Prefs
	{
		...
		public bool no_flex_in_history { get; set; }
		public string newxp_seen_last_message { get; set; }
		public bool attachments_no_borders { get; set; }
	...
	public class Icon
	{
		...
		public bool image_default { get; set; }
	}
